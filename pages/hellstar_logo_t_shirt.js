const images = ["../assets/items/hellstar_logo_t_shirt/1.png", "../assets/items/hellstar_logo_t_shirt/2.png", "../assets/items/hellstar_logo_t_shirt/3.png", "../assets/items/hellstar_logo_t_shirt/4.png"];
let currentIndex = 0;
