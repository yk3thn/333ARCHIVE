const images = ["../assets/items/helmut_lang_dress_pants/1.png", "../assets/items/helmut_lang_dress_pants/2.png", "../assets/items/helmut_lang_dress_pants/3.png", "../assets/items/helmut_lang_dress_pants/4.png"];
let currentIndex = 0;
