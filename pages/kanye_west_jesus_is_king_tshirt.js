const images = ["../assets/items/kanye_west_jesus_is_king_tshirt/1.png", "../assets/items/kanye_west_jesus_is_king_tshirt/2.png", "../assets/items/kanye_west_jesus_is_king_tshirt/3.png"];
let currentIndex = 0;
