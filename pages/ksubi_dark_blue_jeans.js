const images = ["../assets/items/ksubi_dark_blue_jeans/1.png", "../assets/items/ksubi_dark_blue_jeans/2.png", "../assets/items/ksubi_dark_blue_jeans/3.png", "../assets/items/ksubi_dark_blue_jeans/4.png"];
let currentIndex = 0;
